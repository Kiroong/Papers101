...
const PapersTabularView: React.FC = () => {
    ...
    const paperEntries = useRootSelector((state) =>
        state.overview.paperEntries
            .filter(
                (entry) => !seedPapers.map((e) => e.doi).includes(entry.doi)
            )
            .slice(0, 100)
    )
                                    ...
                                    <>
                                        <div>
                                            <input
                                                type="checkbox"
                                                style={{ height: 12 }}
                                                checked={markedPapers.includes(
                                                    entry
                                                )}
                                                onChange={() => {
                                                    if (
                                                        markedPapers.includes(
                                                            entry
                                                        )
                                                    ) {
                                                        dispatch(
                                        ...
                                        <div>
                                            <SimilaritiesBar
                                                ...
                                                maxOfSum={
                                                    referencedBySeedPapersMaxOfSum
                                                }
                                            />
                                        </div>
                                        <div>
